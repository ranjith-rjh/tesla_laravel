...
<div class="englobe">
    <div class="pageModele resized1">
        <div class="configuration_container">
            <div class="slider_container">
                <div class="centered">
                        <div class="div_title_bandeau_aide dpba_panier">
                            <h1>Configuration : Jantes</h1>  
                            <div class="div_petit_bandeau_aide">?</div>
                        </div>
                    </div>  
                    <div class="configuration_choix">
                        @foreach($choix_options as $option)
                            <img src="{{$option->lien_photo}}" alt="{{$option->lien_photo}}" class="configuration_choix_cercle" id="option_{{$option->libelle}}_{{$option->cout}}_{{$option->description}}_{{$option->choix_option_id}}_jante">
                        @endforeach
                    </div>      
                    <div class="configuration_description_choix">
                        ...
                        <a href="//51.83.36.122:8245/modeles/{{str_replace(" ","%20", $modele)}}/motorisation/{{str_replace(" ","%20", $motorisation)}}/" class="btn_config_choisir">Précédent</a>
    ...
    <div class="div_bandeau_aide">
        ...
        <h2 class="title_aide">Besoin d'aide ?</h2>
            <div class="div_groupe_text_aide">
                <p class="petit_title_aide" >Configuration : choisir des jantes</p>
                <div class="div_txt_aide displayedNone" >
                    <p class="txt_aide">- Comparez les différentes styles de jantes disponibles, et choisissez-en une. Le style de jantes choisi est celui entouré par un cercle.</p>
                    <hr>
                    <p class="txt_aide">- A Noter : Le prix varie en fonction du style choisi. Ce dernier sera ajouté au prix total.</p>
                    <hr>
            ...
            <div class="div_groupe_text_aide">
                <p class="petit_title_aide" >Je me suis trompé de couleur</p>
                <div class="div_txt_aide displayedNone" >

...
<div class="englobe">
                ...
                <div class="centered">
                    ...
                    <div class="configuration_choix">
                        @foreach($choix_options as $option)
                            ...
                            <img src="{{$option->lien_photo}}" alt="{{$option->lien_photo}}" class="configuration_choix_cercle" id="option_{{$option->libelle}}_{{$option->cout}}_{{$option->description}}_{{$option->choix_option_id}}_couleur">
                        @endforeach
                    </div>      
                    <div class="configuration_description_choix">
                        ...
                        <div class="configuration_navigation">
                            <a href="//51.83.36.122:8245/modeles/{{str_replace(" ","%20", $modele)}}" class="btn_config_choisir">Précédent</a>
    ...
    <div class="div_bandeau_aide">
        <div class="div_bandeau_aide_content displayedNone">
            ...
            <div class="div_groupe_text_aide">
                <p class="petit_title_aide" >Configuration : choisir une couleur de peinture</p>
                <div class="div_txt_aide displayedNone" >
                    <p class="txt_aide">- Comparez les différentes couleurs disponibles et choisissez-en une. La couleur choisie est celle entourée par un cercle.</p>
                    <hr>
                    <p class="txt_aide">- A Noter : Le prix affiché varie en fonction de la couleur choisie. Il sera ajouté au prix total.</p>
                    <hr>
            ...
            <div class="div_groupe_text_aide">
                <p class="petit_title_aide" >Je me suis trompé de motorisation</p>
                <div class="div_txt_aide displayedNone" >
    ...
    @else
    <div class="bug">
    <h1 >Ce modèle n'est pas encore disponible ...</h1>
    <a href="//51.83.36.122:8245/modeles/{{str_replace(" ","%20", $modele)}}" class="btn_config_choisir">Précédent</a>
    </div>
    @endif
